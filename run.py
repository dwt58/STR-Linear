...
def main():
    ...
    # NewAdvancedCycleNet中STGNN相关参数
    parser.add_argument('--gnn_layers', type=int, default=2, help='number of GNN layers in AdvancedCycleNet')
    parser.add_argument('--gnn_hidden', type=int, default=256, help='hidden dimension in GNN')
